---
title: 'Upgrading from v6.x to v7.0'
sidebarTitle: 'v6.x to v7.0'
---

## Overview

<Warning>Please don't upgrade multiple versions at once (eg. from v5 to v7). Please upgrade one step at a time.</Warning>
