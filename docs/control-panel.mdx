---
title: 'Control Panel'
description: Runway creates listing and publish forms for your Eloquent models, allowing you to manage them just like you would with entries.
---
...
![Screenshot of Control Panel Listing View](/images/cp-listing-view.png)
...
![Screenshot of Runway's User Permissions](/images/cp-user-permissions.png)
...
```php resources/lang/pt_BR/runway.php
'permissions' => [
...
```php app/Policies/ResourcePolicy.php
<?php
...
![Control Panel Filters](/images/cp-filters.png)
...
{
    #[Scope]
	protected function runwaySearch(Builder $query, string $searchTerm): void
	{
