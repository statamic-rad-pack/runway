---
title: Relationships
description: Relationships are an important part of any web application. Runway provides a way to manage Eloquent relationships within Statamic.
---
...
| `title_format`      | Configure the title format used for displaying results in the fieldtype. You can use Antlers to pull in model data, including [fields nested inside JSON columns](/blueprints#nesting-fields-inside-json-columns) (eg. `{{ address_street_name }}`).                                                                                                                                                                                                            |
